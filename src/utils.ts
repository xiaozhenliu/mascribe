...
export const I18N: Record<UiLang, Record<string, string>> = {
  en: {
    ...
    api_settings_hint: "OpenAI-compatible endpoint",
    api_guide_btn: "Setup Guide",
    ...
    detect_ollama_models: "Load Models",
